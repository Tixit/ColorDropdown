...
var copywrite = '/* Copyright (c) 2013 Tixit - Free to use for any purpose: MIT License*/'

console.log('building and minifying...')
var name = 'ColorDropdown'
build(name, true, {output: {path:buildDirectory}, header: copywrite, name:name, minify:true})
